...
inline bool args_do_not_exist(int argc, char* argv[])
{
    if (argc < (MIN_ARGS + 1)) {
...
inline bool test_load_binary(int argc, char* argv[])
{
...
inline bool test_print_binary_code_w_row_length(int argc, char* argv[])
{
    if (args_do_not_exist(argc, argv)) { return false; }
...
inline bool test_print_binary_code_default_row_length(int argc, char* argv[])
{
    if (args_do_not_exist(argc, argv)) { return false; }
...
inline bool test_print_binary_file_w_row_length(int argc, char* argv[])
{
    if (args_do_not_exist(argc, argv)) { return false; }
...
inline bool test_print_binary_file_default_row_length(int argc, char* argv[])
{
    if (args_do_not_exist(argc, argv)) { return false; }
...
static int passed{0};
static int total{0};
inline bool test_case(const std::string& test_name, bool (*test_function)(int, char**), int argc, char* argv[])
{
    total++;
